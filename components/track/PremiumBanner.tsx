...
export function PremiumBanner() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-r from-tcell-accent/25 via-transparent to-amber-400/15" />

      {/* Border glow */}
      <div className="absolute inset-0 rounded-2xl border border-amber-400/20 shadow-[0_0_20px_rgba(212,160,23,0.15)]" />
      ...
      <div className="relative p-4">
        <div className="flex items-center gap-2.5 mb-3">
          <div className="w-8 h-8 rounded-xl bg-linear-to-br from-amber-400/30 to-tcell-accent/30 flex items-center justify-center">
          ...
          <div>
            ...
            <p className="text-[10px] text-amber-400/70 font-medium">Разблокируй весь Наврўз</p>
          </div>
          <div className="ml-auto bg-amber-400/15 border border-amber-400/30 rounded-full px-2.5 py-0.5">
            <span className="text-[10px] font-black text-amber-400">19 с/мес</span>
          </div>
        </div>
        ...
        <div className="space-y-1.5 mb-3">
          {PERKS.map((perk) => (
            <div key={perk} className="flex items-center gap-2">
              <div className="w-3.5 h-3.5 rounded-full bg-amber-400/20 flex items-center justify-center shrink-0">
